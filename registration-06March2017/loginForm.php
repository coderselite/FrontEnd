  ...
  <div class="row">
	<div class="col-md-6 col-md-offset-3">
	  <hr/>
		<div class="row">
			<div class="col-lg-12">
			  <form id="login-form" action="login.php?status=validateLogin" method="post" role="form" class="">
				...
				<div class="col-8 form-group">
				  ...
				  <input type="password" class="form-control" id="user_password" name="user_password" required pattern="^(?=.*[0-9])(?=.*[!@#$%^&*])(?=.*[a-z])(?=.*[A-Z])[a-zA-Z0-9!@#$%^&*]{6,16}$" title="Please enter your password" placeholder="Enter password">
				</div>
        ...
        <div class="form-group">
            <div class="col-8">
              <div class="text-center">
                <a href="recoverPasswordForm.php"  tabindex="5" class="forgot-password">Forgot Password?</a>
              </div>
            </div>
        </div>
			  </form>
